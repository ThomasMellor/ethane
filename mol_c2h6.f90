...
tau35 = -2.0_ark/3.0_ark*Pi+1.0_ark/3.0_ark*sqrt(3.0_ark)*S18+1.0_ark/3.0_ark*sqrt(2.0_ark)*S15-1.0_ark/3.0_ark*sqrt(2.0_ark)*S17
 ...
 !
    ...
    temp(37:72)   = (/ 0, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 37, 27, 37, 37, 37, 37, 37, 37, 37, 37, 37/)
    ...
    case('R-R16-BETA16-THETA-TAU-2')
      ...
      case('G36(M)')
        ...
        case (2) !C(+)/(123)(456)
          ...
          dst(17) = -b*src(16) - a*src(17)
          !
          dst(18) = mod(src(18) - 2.0_ark*pi/3.0_ark, 2.0_ark*pi)
          !
        case (4) !sxy(+)/(14)(26)(35)(ab)* 
          ...
          dst(17) = -b*src(14) - a*src(15)
          !
          dst(18) =  mod(4.0_ark*pi/3.0_ark - src(18), 2.0_ark*pi)
          !
        case (7) ! C(-)/(132)(456)
          !
          dst(1) = src(1)
