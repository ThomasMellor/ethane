...
module mol_ch4
  ...
  public MLpoten_xy4_qz_f12,MLpotential_xy4_qz_f12,MLdipole_xy4_dF
...
! Yurchenko, June 2011
! 
  function MLpoten_xy4_qz_f12(local,xyz)  result(f)
    !
    real(ark),intent(in) :: local(:),xyz(5,3)
    real(ark)            :: f
     !
     f =  MLpotential_xy4_qz_f12(local,xyz,molec%force)
     !
  end function MLpoten_xy4_qz_f12


  function MLpotential_xy4_qz_f12(local,xyz,force)  result(f)
    !
    real(ark),intent(in) ::  local(:),xyz(5,3)
    ...
    real(ark) :: dF(n),f
     ...
     enddo
     !
  end function MLpotential_xy4_qz_f12
