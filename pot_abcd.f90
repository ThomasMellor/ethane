...
subroutine potC2H2_D8h_415_diff_V(n,y1,y2,y3,y4,y5,y6,y7,dF)
 ...
 function MLpoten_cucch_7_q2q1q4q3(ncoords,natoms,local,xyz,force) result(f)
   !
   integer(ik),intent(in) ::  ncoords,natoms
   real(ark),intent(in)   ::  local(ncoords)
   real(ark),intent(in)   ::  xyz(natoms,3)
   ...
   real(ark)              ::  f
    ...
    real(ark) :: dF(n)
      ...
      df(N0+16) = y1*y2
      df(N0+17) = y1**2
      df(N0+18) = (y7**2+y6**2)*y3
      df(N0+19) = (y4*y6+y5*y7)*y3
      df(N0+20) = (y4**2+y5**2)*y3
      df(N0+21) = y3**3
      df(N0+22) = (y7**2+y6**2)*y2
      df(N0+23) = (y4*y6+y5*y7)*y2
      df(N0+24) = (y4**2+y5**2)*y2
      df(N0+25) = y2*y3**2
      df(N0+26) = y2**2*y3
      df(N0+27) = y2**3
      df(N0+28) = (y7**2+y6**2)*y1
      df(N0+29) = (y4*y6+y5*y7)*y1
      df(N0+30) = (y4**2+y5**2)*y1
      df(N0+31) = y1*y3**2
      df(N0+32) = y1*y2*y3
      df(N0+33) = y1*y2**2
      df(N0+34) = y1**2*y3
      df(N0+35) = y1**2*y2
      df(N0+36) = y1**3
      df(N0+37) = y6**4+2.0_ark*y6**2*y7**2+y7**4
      df(N0+38) = (y6**3+y6*y7**2)*y4+(y6**2*y7+y7**3)*y5
      df(N0+39) = y5**2*y6**2+y4**2*y7**2-2.0_ark*y4*y5*y6*y7
      df(N0+40) = y4**2*y6**2+y5**2*y7**2+2.0_ark*y4*y5*y6*y7
      df(N0+41) = y4**2*y5*y7+y4*y5**2*y6+y5**3*y7+y4**3*y6
      df(N0+42) = y4**2*y5**2+y4**4/2.0_ark+y5**4/2.0_ark
      df(N0+43) = (y7**2+y6**2)*y3**2
      df(N0+44) = (y4*y6+y5*y7)*y3**2
      df(N0+45) = (y4**2+y5**2)*y3**2
      df(N0+46) = y3**4
      df(N0+47) = (y7**2+y6**2)*y3*y2
      df(N0+48) = (y4*y6+y5*y7)*y3*y2
      df(N0+49) = (y4**2+y5**2)*y3*y2
      df(N0+50) = y2*y3**3
      df(N0+51) = (y7**2+y6**2)*y2**2
      df(N0+52) = (y4*y6+y5*y7)*y2**2
      df(N0+53) = (y4**2+y5**2)*y2**2
      df(N0+54) = y2**2*y3**2
      df(N0+55) = y2**3*y3
      df(N0+56) = y2**4
      df(N0+57) = (y7**2+y6**2)*y3*y1
      df(N0+58) = (y4*y6+y5*y7)*y3*y1
      df(N0+59) = (y4**2+y5**2)*y3*y1
      df(N0+60) = y1*y3**3
      df(N0+61) = (y7**2+y6**2)*y2*y1
      df(N0+62) = (y4*y6+y5*y7)*y2*y1
      df(N0+63) = (y4**2+y5**2)*y2*y1
      df(N0+64) = y1*y2*y3**2
      df(N0+65) = y1*y2**2*y3
      df(N0+66) = y1*y2**3
      df(N0+67) = (y7**2+y6**2)*y1**2
      df(N0+68) = (y4*y6+y5*y7)*y1**2
      df(N0+69) = (y4**2+y5**2)*y1**2
      df(N0+70) = y1**2*y3**2
      df(N0+71) = y1**2*y2*y3
      df(N0+72) = y1**2*y2**2
      df(N0+73) = y1**3*y3
      ...
      enddo
      !
 end function MLpoten_cucch_7_q2q1q4q3
